...
public class ModelLoader {
	...
	public static AnimatedModel loadGameItem(String modelPath, String animationsDir, String texturesDir) throws Exception {
	...
	private static AnimatedModel loadGameItem(String modelPath, String animationsDir, String texturesDir, int flags) throws Exception {
